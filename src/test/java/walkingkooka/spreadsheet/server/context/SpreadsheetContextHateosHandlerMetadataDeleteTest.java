...
public final class SpreadsheetContextHateosHandlerMetadataDeleteTest extends SpreadsheetContextHateosHandlerMetadataTestCase<SpreadsheetContextHateosHandlerMetadataDelete> {

    SpreadsheetContextHateosHandlerMetadataDeleteTest() {
        super();
    }
    ...
    @Override
    SpreadsheetContextHateosHandlerMetadataDelete createHandler(final SpreadsheetContext context) {
    ...
    @Override
    public Class<SpreadsheetContextHateosHandlerMetadataDelete> type() {
        return SpreadsheetContextHateosHandlerMetadataDelete.class;
    }
}
