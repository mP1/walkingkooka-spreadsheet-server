...
public final class ConverterInfoHateosResourceHandlerTest implements HateosResourceHandlerTesting2<ConverterInfoHateosResourceHandler,
    ConverterName,
    ConverterInfo,
    ConverterInfoSet,
    ...
    public void testToString() {
        this.toStringAndCheck(
            this.createHandler(),
            "spreadsheetProvider.converterInfos"
        );
    }
