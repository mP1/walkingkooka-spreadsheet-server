...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearColumnsTest extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearColumns,
    ...
    public void testClearColumn() {
        ...
        final SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearColumns handler = SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearColumns.with(
                engine,
                context
        );
    ...
    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearColumns createHandler(final SpreadsheetEngine engine,
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearColumns> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearColumns.class;
    }
}
