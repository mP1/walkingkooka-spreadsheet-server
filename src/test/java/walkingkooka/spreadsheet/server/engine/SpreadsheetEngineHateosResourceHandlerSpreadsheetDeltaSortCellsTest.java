...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSortCellsTest extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSortCells,
    ...
    public void testOneMissingComparatorsParameter() {
        ...
        this.handleOneFails(
                SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSortCells.with(
    ...
    public void testOne() {
        ...
        this.handleOneAndCheck(
                ...
                Optional.empty(), // resource
                Maps.of(
                        SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSortCells.COMPARATORS, Lists.of(comparators)
                ), // parameters
                Optional.of(
                        delta
                )
    ...
    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSortCells createHandler(final SpreadsheetEngine engine,
                                                                                  final SpreadsheetEngineContext context) {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSortCells.with(
                engine,
                context
        );
    }
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSortCells> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSortCells.class;
    }
}
