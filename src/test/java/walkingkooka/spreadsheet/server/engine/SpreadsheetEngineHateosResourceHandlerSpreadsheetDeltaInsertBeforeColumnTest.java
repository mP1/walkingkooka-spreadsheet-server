...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeColumnTest extends
        SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeColumn, SpreadsheetColumnReference> {
    ...
    public void testInsertBeforeColumn() {
        ...
        final SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeColumn handler = SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeColumn.with(
                engine,
                context
        );
    ...
    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeColumn createHandler(final SpreadsheetEngine engine,
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeColumn> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeColumn.class;
    }
}
