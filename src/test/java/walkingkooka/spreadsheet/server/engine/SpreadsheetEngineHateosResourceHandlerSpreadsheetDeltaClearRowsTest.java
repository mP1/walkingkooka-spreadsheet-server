...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearRowsTest extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearRows,
    ...
    public void testClearRow() {
        ...
        final SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearRows handler = SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearRows.with(
                engine,
                context
        );
    ...
    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearRows createHandler(final SpreadsheetEngine engine,
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearRows> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearRows.class;
    }
}
