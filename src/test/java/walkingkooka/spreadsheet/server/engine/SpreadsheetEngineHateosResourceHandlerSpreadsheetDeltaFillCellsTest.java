...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCellsTest extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells,
    ...
    public void testFillFromParameterEmptyFails() {
        this.handleRangeFails(
                ...
                Maps.of(
                        SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells.FROM, Lists.empty()
                ),
    ...
    public void testFillFromParameterInvalidFails() {
        this.handleRangeFails(
                ...
                this.collectionResource(),
                Maps.of(
                        SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells.FROM, Lists.of("!INVALID")
                ),
                IllegalArgumentException.class
        );
    }
    ...
    public void testFillFromParameterPresent() {
        this.handleRangeAndCheck2(
                Maps.of(
                        SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells.FROM, Lists.of(TO)
                ),
    ...
    public void testFillFromParameterPresent2() {
        this.handleRangeAndCheck2(
                Maps.of(
                        SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells.FROM, Lists.of(TO, FROM)
                ),
                this.toSpreadsheetCellRangeReference()
        );
    }
    ...
    private void handleRangeAndCheck2(final Map<HttpRequestAttribute<?>, Object> parameters,
        ...
        this.handleRangeAndCheck(
                SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells.with(
    ...
    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells createHandler(final SpreadsheetEngine engine,
                                                                                  final SpreadsheetEngineContext context) {
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells.class;
    }
}
