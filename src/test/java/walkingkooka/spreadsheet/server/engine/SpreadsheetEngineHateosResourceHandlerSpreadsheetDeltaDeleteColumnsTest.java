...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteColumnsTest extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteColumns,
    ...
    private SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteColumns createHandler(final SpreadsheetEngine engine) {
        return this.createHandler(engine, this.engineContext());
    }

    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteColumns createHandler(final SpreadsheetEngine engine,
                                                                                      final SpreadsheetEngineContext context) {
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteColumns> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteColumns.class;
    }
}
