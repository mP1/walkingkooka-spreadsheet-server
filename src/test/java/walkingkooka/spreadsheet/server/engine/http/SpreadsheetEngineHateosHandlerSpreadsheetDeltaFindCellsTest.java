...
public final class SpreadsheetEngineHateosHandlerSpreadsheetDeltaFindCellsTest extends SpreadsheetEngineHateosHandlerSpreadsheetDeltaTestCase<SpreadsheetEngineHateosHandlerSpreadsheetDeltaFindCells,
                ...
                SpreadsheetEngineHateosHandlerSpreadsheetDeltaFindCells.with(
                        ...
                        new FakeSpreadsheetEngine() {
                            ...
                            public Set<SpreadsheetCell> findCells(final SpreadsheetCellRange r,
                                                                  ...
                                                                  final SpreadsheetEngineContext context) {
                                checkEquals(range, r, "range");
                                checkEquals(SpreadsheetEngineHateosHandlerSpreadsheetDeltaFindCells.DEFAULT_CELL_RANGE_PATH, p, "path");
                                checkEquals(SpreadsheetEngineHateosHandlerSpreadsheetDeltaFindCells.DEFAULT_OFFSET, o, "offset");
                                checkEquals(DEFAULT_MAX, m, "max");
                                checkEquals(SpreadsheetEngineHateosHandlerSpreadsheetDeltaFindCells.DEFAULT_VALUE_TYPE, v, "valueType");
                                checkEquals(SpreadsheetEngineHateosHandlerSpreadsheetDeltaFindCells.DEFAULT_QUERY, e, "expression");
    ...
    @Override
    SpreadsheetEngineHateosHandlerSpreadsheetDeltaFindCells createHandler(final SpreadsheetEngine engine,
                                                                          final SpreadsheetEngineContext context) {
    ...
    @Override
    public Class<SpreadsheetEngineHateosHandlerSpreadsheetDeltaFindCells> type() {
        return SpreadsheetEngineHateosHandlerSpreadsheetDeltaFindCells.class;
    }
}
