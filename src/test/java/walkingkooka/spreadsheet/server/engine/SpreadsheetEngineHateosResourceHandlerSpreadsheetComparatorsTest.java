...
public class SpreadsheetEngineHateosResourceHandlerSpreadsheetComparatorsTest extends SpreadsheetEngineHateosResourceHandlerTestCase2<SpreadsheetEngineHateosResourceHandlerSpreadsheetComparators,
        SpreadsheetComparatorName,
        SpreadsheetComparatorInfo,
        SpreadsheetComparatorInfoSet> implements ToStringTesting<SpreadsheetEngineHateosResourceHandlerSpreadsheetComparators> {
    ...
    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetComparators createHandler(final SpreadsheetEngine engine,
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetComparators> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetComparators.class;
    }
}
