...
public abstract class SpreadsheetEngineHateosResourceHandlerTestCase2<H extends SpreadsheetEngineHateosResourceHandler<I, V, C>, I extends Comparable<I>, V, C>
        extends SpreadsheetEngineHateosResourceHandlerTestCase<H>
        implements HateosResourceHandlerTesting<H, I, V, C>,
        ToStringTesting<H> {

    SpreadsheetEngineHateosResourceHandlerTestCase2() {
        super();
    }
