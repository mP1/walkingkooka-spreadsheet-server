...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCellTest
        extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCell,
    ...
    public void testHandleSaveWithQuery() {
        ...
        this.handleOneAndCheck(
                SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCell.with(
                        new FakeSpreadsheetEngine() {
                            @Override
                            public SpreadsheetDelta saveCell(final SpreadsheetCell cell,
                                ...
                                checkEquals(SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCellTest.this.cell(), cell, "cell");
                                checkNotEquals(null, context, "context");
    ...
    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCell createHandler(final SpreadsheetEngine engine,
                                                                                 final SpreadsheetEngineContext context) {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCell.with(engine, context);
    }

    private SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCell createHandler(final SpreadsheetEngine engine) {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCell.with(engine, this.engineContext());
    }
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCell> type() {
        return Cast.to(SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCell.class);
    }
}
