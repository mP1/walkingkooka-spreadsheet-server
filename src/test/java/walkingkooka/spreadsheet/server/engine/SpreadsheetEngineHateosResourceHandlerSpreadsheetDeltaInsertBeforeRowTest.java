...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeRowTest extends
        SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeRow, SpreadsheetRowReference> {
    ...
    public void testInsertBeforeRow() {
        ...
        final SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeRow handler = SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeRow.with(
                engine,
                context
        );
    ...
    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeRow createHandler(final SpreadsheetEngine engine,
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeRow> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeRow.class;
    }
}
