...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteCellTest extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaTestCase<
        SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteCell,
    ...
    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteCell createHandler(final SpreadsheetEngine engine,
                                                                                   final SpreadsheetEngineContext context) {
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteCell> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteCell.class;
    }
}
