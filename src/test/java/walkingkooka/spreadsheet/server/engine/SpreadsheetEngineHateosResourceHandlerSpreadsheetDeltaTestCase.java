...
public abstract class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaTestCase<H extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta<I>,
        I extends Comparable<I>>
        extends SpreadsheetEngineHateosResourceHandlerTestCase2<H, I, SpreadsheetDelta, SpreadsheetDelta>
        implements HateosResourceHandlerTesting<H, I, SpreadsheetDelta, SpreadsheetDelta>,
        PredicateTesting,
        ToStringTesting<H> {

    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaTestCase() {
        super();
    }
