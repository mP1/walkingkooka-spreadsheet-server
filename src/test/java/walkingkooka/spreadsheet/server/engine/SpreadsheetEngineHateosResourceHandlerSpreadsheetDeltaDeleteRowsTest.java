...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteRowsTest extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteRows,
    ...
    private SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteRows createHandler(final SpreadsheetEngine engine) {
        return this.createHandler(engine, this.engineContext());
    }

    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteRows createHandler(final SpreadsheetEngine engine,
                                                                                   final SpreadsheetEngineContext context) {
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteRows> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDeleteRows.class;
    }
}
