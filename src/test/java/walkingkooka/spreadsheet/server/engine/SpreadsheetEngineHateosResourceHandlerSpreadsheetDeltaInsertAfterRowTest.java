...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterRowTest extends
        SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterRow, SpreadsheetRowReference> {
    ...
    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterRow createHandler(final SpreadsheetEngine engine,
                                                                                       final SpreadsheetEngineContext context) {
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterRow> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterRow.class;
    }
}
