...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCellsTest extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells,
    ...
    public void testWithNegativeDefaultMax() {
        assertThrows(
                ...
                () -> SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells.with(
                        -1,
                ...
                SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells.with(
                        ...
                        new FakeSpreadsheetEngine() {
                            ...
                            public Set<SpreadsheetCell> findCells(final SpreadsheetCellRangeReference r,
                                                                  ...
                                                                  final SpreadsheetEngineContext context) {
                                checkEquals(range, r, "range");
                                checkEquals(SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells.DEFAULT_CELL_RANGE_PATH, p, "path");
                                checkEquals(SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells.DEFAULT_OFFSET, o, "offset");
                                checkEquals(DEFAULT_MAX, m, "max");
                                checkEquals(SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells.DEFAULT_VALUE_TYPE, v, "valueType");
                                checkEquals(SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells.DEFAULT_QUERY, e, "expression");
    ...
    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells createHandler(final SpreadsheetEngine engine,
                                                                                  final SpreadsheetEngineContext context) {
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells.class;
    }
}
