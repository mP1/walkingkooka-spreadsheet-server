...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterColumnTest extends
        SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterColumn, SpreadsheetColumnReference> {
    ...
    @Override
    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterColumn createHandler(final SpreadsheetEngine engine,
                                                                                          final SpreadsheetEngineContext context) {
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterColumn> type() {
        return SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterColumn.class;
    }
}
