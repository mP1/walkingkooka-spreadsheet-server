...
public final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaTest extends SpreadsheetEngineHateosResourceHandlerTestCase<SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta<?>> {
    ...
    private void prepareResponseAndCheck(final Optional<SpreadsheetDelta> input,
        ...
        final SpreadsheetDelta response = new SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta<Integer>(
    ...
    @Override
    public Class<SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta<?>> type() {
        return Cast.to(SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta.class);
    }
}
