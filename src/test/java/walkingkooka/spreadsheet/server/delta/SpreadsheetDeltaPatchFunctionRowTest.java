...
public final class SpreadsheetDeltaPatchFunctionRowTest extends SpreadsheetDeltaPatchFunctionTestCase<SpreadsheetDeltaPatchFunctionRow, SpreadsheetRowRangeReference> {
    ...
    public void testPatchRowOutOfRangeFails() {
        ...
        final IllegalArgumentException thrown = assertThrows(
                ...
                () -> SpreadsheetDeltaPatchFunctionRow.with(
                        new FakeHttpRequest() {
                            @Override
    ...
    @Override
    public SpreadsheetDeltaPatchFunctionRow createFunction(final HttpRequest request,
                                                           final SpreadsheetEngine engine,
                                                           final SpreadsheetEngineContext context) {
        return SpreadsheetDeltaPatchFunctionRow.with(
                request,
                engine,
                context
        );
    ...
    @Override
    public Class<SpreadsheetDeltaPatchFunctionRow> type() {
        return SpreadsheetDeltaPatchFunctionRow.class;
    }
}