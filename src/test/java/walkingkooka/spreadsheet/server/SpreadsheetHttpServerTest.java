        ...
        server.handleAndCheck(
            ...
            this.response(
                ...
                "{\n" +
                    ...
                    "  \"findConverter\": \"collection(null-to-number, simple, number-to-number, text-to-text, error-to-number, error-throwing, text-to-expression, text-to-locale, text-to-spreadsheet-selection, selection-to-selection, spreadsheet-selection-to-text, general)\",\n" +
                    "  \"findFunctions\": \"@\",\n" +
                    "  \"formHandlers\": \"\",\n" +
                    ...
                    "  \"formattingConverter\": \"collection(null-to-number, simple, number-to-number, text-to-text, error-to-number, error-throwing, text-to-error, text-to-expression, text-to-locale, text-to-template-value-name, text-to-url, text-to-spreadsheet-selection, selection-to-selection, spreadsheet-selection-to-text, spreadsheet-cell-to, has-style-to-style, text-to-color, color-to-number, number-to-color, color-to-color, text-to-spreadsheet-color-name, text-to-spreadsheet-formatter-selector, text-to-spreadsheet-metadata-color, text-to-spreadsheet-text, text-to-text-node, text-to-text-style, text-to-text-style-property-name, to-styleable, to-text-node, url-to-hyperlink, url-to-image, general)\",\n" +
                    "  \"formattingFunctions\": \"@\",\n" +
                    "  \"formulaConverter\": \"collection(null-to-number, simple, number-to-number, text-to-text, error-to-number, error-throwing, text-to-error, text-to-spreadsheet-selection, selection-to-selection, spreadsheet-selection-to-text, text-to-expression, text-to-locale, text-to-template-value-name, text-to-url, general)\",\n" +
                    ...
                    "  \"scriptingConverter\": \"collection(null-to-number, simple, number-to-number, text-to-text, error-to-number, error-throwing, text-to-error, text-to-environment-value-name, text-to-expression, text-to-locale, text-to-template-value-name, text-to-url, text-to-spreadsheet-selection, selection-to-selection, spreadsheet-selection-to-text, spreadsheet-cell-to, has-style-to-style, text-to-color, color-to-number, number-to-color, color-to-color, text-to-spreadsheet-color-name, text-to-spreadsheet-formatter-selector, text-to-spreadsheet-metadata-color, text-to-spreadsheet-text, text-to-text-node, text-to-text-style, text-to-text-style-property-name, to-styleable, to-text-node, url-to-hyperlink, url-to-image, text-to-spreadsheet-id, text-to-spreadsheet-metadata, text-to-spreadsheet-metadata-property-name, text-to-spreadsheet-name,general)\",\n" +
                    "  \"scriptingFunctions\": \"@\",\n" +
                    ...
                    "  \"sortConverter\": \"collection(null-to-number, simple, number-to-number, text-to-text, error-to-number, error-throwing, text-to-expression, text-to-locale, text-to-spreadsheet-selection, selection-to-selection, spreadsheet-selection-to-text, general)\",\n" +
                    "  \"style\": {\n" +
                    "    \"height\": \"50px\",\n" +
                    "    \"width\": \"100px\"\n" +
                    "  },\n" +
                    ...
                    "  \"twoDigitYear\": 50,\n" +
                    "  \"validationConverter\": \"collection(null-to-number, simple, number-to-number, text-to-text, error-to-number, text-to-error, text-to-expression, text-to-locale, text-to-spreadsheet-selection, selection-to-selection, spreadsheet-selection-to-text, text-to-form-name, text-to-validation-error, text-to-validator-selector, text-to-value-type, to-validation-error-list,general)\",\n" +
                    "  \"validationFunctions\": \"@\",\n" +
