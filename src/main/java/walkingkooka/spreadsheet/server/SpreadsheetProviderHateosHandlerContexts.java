...
public final class SpreadsheetProviderHateosHandlerContexts implements PublicStaticHelper {
    ...
    /**
     * {@see FakeSpreadsheetProviderHateosHandlerContext}
     */
    public static SpreadsheetProviderHateosHandlerContext fake() {
        return new FakeSpreadsheetProviderHateosHandlerContext();
    }

    /**
     * Stop creation
     */
    private SpreadsheetProviderHateosHandlerContexts() {
