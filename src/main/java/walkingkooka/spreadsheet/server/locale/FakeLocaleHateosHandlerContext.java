...
public class FakeLocaleHateosHandlerContext extends FakeHateosHandlerContext implements LocaleHateosHandlerContext {

    public FakeLocaleHateosHandlerContext() {
        super();
    }
