 ...
 */
public interface SpreadsheetMetadataHateosHandlerContext extends SpreadsheetServerContext {

    @Override
    SpreadsheetMetadataHateosHandlerContext setObjectPostProcessor(final JsonNodeMarshallContextObjectPostProcessor processor);

    @Override
    SpreadsheetMetadataHateosHandlerContext setPreProcessor(final JsonNodeUnmarshallContextPreProcessor processor);
    ...
    @Override
    default SpreadsheetMetadataHateosHandlerContext setEnvironmentContext(final EnvironmentContext environmentContext) {
        throw new UnsupportedOperationException();
    }
