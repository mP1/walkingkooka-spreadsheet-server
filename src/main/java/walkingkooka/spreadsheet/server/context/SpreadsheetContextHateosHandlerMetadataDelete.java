 ...
 */
final class SpreadsheetContextHateosHandlerMetadataDelete extends SpreadsheetContextHateosHandlerMetadata {

    static SpreadsheetContextHateosHandlerMetadataDelete with(final SpreadsheetContext context) {
        checkContext(context);

        return new SpreadsheetContextHateosHandlerMetadataDelete(context);
    }

    private SpreadsheetContextHateosHandlerMetadataDelete(final SpreadsheetContext context) {
        super(context);
    }
