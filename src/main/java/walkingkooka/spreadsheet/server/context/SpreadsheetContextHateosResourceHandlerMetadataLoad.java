 ...
 */
final class SpreadsheetContextHateosResourceHandlerMetadataLoad extends SpreadsheetContextHateosResourceHandlerMetadata {

    static SpreadsheetContextHateosResourceHandlerMetadataLoad with(final SpreadsheetContext context) {
        checkContext(context);

        return new SpreadsheetContextHateosResourceHandlerMetadataLoad(context);
    }

    private SpreadsheetContextHateosResourceHandlerMetadataLoad(final SpreadsheetContext context) {
        super(context);
    }
