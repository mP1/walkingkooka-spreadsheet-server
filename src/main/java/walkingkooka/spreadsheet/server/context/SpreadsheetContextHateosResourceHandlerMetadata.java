 ...
 */
abstract class SpreadsheetContextHateosResourceHandlerMetadata implements HateosResourceHandler<SpreadsheetId, SpreadsheetMetadata, SpreadsheetMetadataSet> {
    ...
    SpreadsheetContextHateosResourceHandlerMetadata(final SpreadsheetContext context) {
        super();
