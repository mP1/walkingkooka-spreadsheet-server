...
public interface SpreadsheetEngineHateosHandlerContext extends HateosHandlerContext,
    ...
    @Override
    SpreadsheetEngineHateosHandlerContext cloneEnvironment();
    ...
    @Override
    SpreadsheetEngineHateosHandlerContext setObjectPostProcessor(final JsonNodeMarshallContextObjectPostProcessor processor);

    @Override
    SpreadsheetEngineHateosHandlerContext setPreProcessor(final JsonNodeUnmarshallContextPreProcessor processor);
