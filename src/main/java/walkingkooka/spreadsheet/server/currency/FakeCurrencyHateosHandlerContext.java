...
public class FakeCurrencyHateosHandlerContext extends FakeHateosHandlerContext implements CurrencyHateosHandlerContext {

    public FakeCurrencyHateosHandlerContext() {
        super();
    }
