...
public interface CurrencyHateosResourceHandlerContextTesting<C extends CurrencyHateosResourceHandlerContext> extends CurrencyContextTesting2<C>, HateosResourceHandlerContextTesting<C> {
