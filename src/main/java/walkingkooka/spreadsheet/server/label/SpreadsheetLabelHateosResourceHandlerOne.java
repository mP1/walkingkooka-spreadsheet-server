...
abstract class SpreadsheetLabelHateosResourceHandlerOne extends SpreadsheetLabelHateosResourceHandler {

    SpreadsheetLabelHateosResourceHandlerOne(final SpreadsheetLabelStore store) {
        super(store);
    }
