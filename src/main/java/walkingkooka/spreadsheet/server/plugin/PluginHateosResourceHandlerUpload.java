 ...
 */
final class PluginHateosResourceHandlerUpload implements HateosHttpEntityHandler<PluginName, PluginHateosResourceHandlerContext>,
    ...
    final static PluginHateosResourceHandlerUpload INSTANCE = new PluginHateosResourceHandlerUpload();

    private PluginHateosResourceHandlerUpload() {
        super();
    }
