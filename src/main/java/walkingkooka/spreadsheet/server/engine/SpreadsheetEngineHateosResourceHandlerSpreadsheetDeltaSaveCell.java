 ...
 */
final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCell extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta2<SpreadsheetCellReference> {

    static SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCell with(final SpreadsheetEngine engine,
                                                                               final SpreadsheetEngineContext context) {
        check(engine, context);
        return new SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCell(engine, context);
    }

    private SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSaveCell(final SpreadsheetEngine engine,
                                                                           final SpreadsheetEngineContext context) {
