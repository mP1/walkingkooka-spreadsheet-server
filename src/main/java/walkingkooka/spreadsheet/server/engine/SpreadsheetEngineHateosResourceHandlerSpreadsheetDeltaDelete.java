 ...
 */
abstract class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDelete<R extends SpreadsheetColumnOrRowReference & Comparable<R>> extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta2<R> {

    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaDelete(final SpreadsheetEngine engine,
