 ...
 */
abstract class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsert<R extends SpreadsheetColumnOrRowReference & Comparable<R>>
        extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta2<R> {

    SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsert(final SpreadsheetEngine engine,
