...
final class SpreadsheetEngineHateosHandlerSpreadsheetDeltaInsertAfterRow extends SpreadsheetEngineHateosHandlerSpreadsheetDeltaInsert<SpreadsheetRowReference> {

    static SpreadsheetEngineHateosHandlerSpreadsheetDeltaInsertAfterRow with(final SpreadsheetEngine engine,
                                                                             final SpreadsheetEngineContext context) {
        check(engine, context);
        return new SpreadsheetEngineHateosHandlerSpreadsheetDeltaInsertAfterRow(engine, context);
    }

    private SpreadsheetEngineHateosHandlerSpreadsheetDeltaInsertAfterRow(final SpreadsheetEngine engine,
                                                                         final SpreadsheetEngineContext context) {
