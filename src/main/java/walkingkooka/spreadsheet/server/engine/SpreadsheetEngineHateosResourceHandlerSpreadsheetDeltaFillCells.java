 ...
 */
final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta2<SpreadsheetCellReference> {

    static SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells with(final SpreadsheetEngine engine,
                                                                                final SpreadsheetEngineContext context) {
        check(engine, context);
        return new SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells(engine, context);
    }

    private SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells(final SpreadsheetEngine engine,
                                                                            final SpreadsheetEngineContext context) {
    ...
    public Optional<SpreadsheetDelta> handleRange(final Range<SpreadsheetCellReference> to,
        ...
        final SpreadsheetCellRangeReference from = FROM.parameterValue(parameters)
                .map(SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFillCells::mapFirstStringValue)
                .orElse(range);
