 ...
 */
final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta<SpreadsheetCellReference> {

    static SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells with(final int defaultMax,
        ...
        return new SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells(
                defaultMax,
                engine,
                context
        );
    ...
    private SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaFindCells(final int defaultMax,
                                                                            final SpreadsheetEngine engine,
                                                                            final SpreadsheetEngineContext context) {
