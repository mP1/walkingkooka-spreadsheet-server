...
final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeRow extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsert<SpreadsheetRowReference> {

    static SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeRow with(final SpreadsheetEngine engine,
                                                                                      final SpreadsheetEngineContext context) {
        check(engine, context);
        return new SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeRow(engine, context);
    }

    private SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeRow(final SpreadsheetEngine engine,
                                                                                  final SpreadsheetEngineContext context) {
