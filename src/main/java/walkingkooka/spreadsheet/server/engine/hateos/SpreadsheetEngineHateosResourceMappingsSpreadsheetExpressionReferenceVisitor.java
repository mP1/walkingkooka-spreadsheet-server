 ...
 */
final class SpreadsheetEngineHateosResourceMappingsSpreadsheetExpressionReferenceVisitor extends SpreadsheetExpressionReferenceVisitor {
    ...
    static Optional<SpreadsheetCellReference> reference(final ExpressionReference reference,
        ...
        final SpreadsheetEngineHateosResourceMappingsSpreadsheetExpressionReferenceVisitor visitor = new SpreadsheetEngineHateosResourceMappingsSpreadsheetExpressionReferenceVisitor(store);
    ...
    SpreadsheetEngineHateosResourceMappingsSpreadsheetExpressionReferenceVisitor(final SpreadsheetLabelStore store) {
        super();
        this.store = store;
    }
