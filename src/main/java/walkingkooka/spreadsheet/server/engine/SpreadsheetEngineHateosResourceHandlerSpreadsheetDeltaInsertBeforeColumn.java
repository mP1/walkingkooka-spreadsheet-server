...
final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeColumn extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsert<SpreadsheetColumnReference> {

    static SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeColumn with(final SpreadsheetEngine engine,
                                                                                         final SpreadsheetEngineContext context) {
        check(engine, context);
        return new SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeColumn(engine, context);
    }

    private SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertBeforeColumn(final SpreadsheetEngine engine,
                                                                                     final SpreadsheetEngineContext context) {
