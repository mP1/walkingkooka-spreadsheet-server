 ...
 * </pre>
 */
final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSortCells extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta<SpreadsheetCellReference> {

    static SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSortCells with(final SpreadsheetEngine engine,
        ...
        return new SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSortCells(
                engine,
                context
        );
    }

    private SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaSortCells(final SpreadsheetEngine engine,
                                                                            final SpreadsheetEngineContext context) {
