...
final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterColumn extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsert<SpreadsheetColumnReference> {

    static SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterColumn with(final SpreadsheetEngine engine,
                                                                                        final SpreadsheetEngineContext context) {
        check(engine, context);
        return new SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterColumn(engine, context);
    }

    private SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaInsertAfterColumn(final SpreadsheetEngine engine,
                                                                                    final SpreadsheetEngineContext context) {
