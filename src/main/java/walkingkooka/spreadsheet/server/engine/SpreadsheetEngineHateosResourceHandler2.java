 ...
 */
abstract class SpreadsheetEngineHateosResourceHandler2<I extends Comparable<I>, V, C> extends SpreadsheetEngineHateosResourceHandler<I, V, C> {

    /**
     * Package private to limit sub classing.
     */
    SpreadsheetEngineHateosResourceHandler2(final SpreadsheetEngine engine,
