 ...
 */
final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaLoadCell extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta<SpreadsheetCellReference> {

    static SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaLoadCell with(final SpreadsheetEngineEvaluation evaluation,
                                                                               final SpreadsheetEngine engine,
                                                                               final SpreadsheetEngineContext context) {
        Objects.requireNonNull(evaluation, "evaluation");

        check(engine, context);
        return new SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaLoadCell(evaluation,
                engine,
                context);
    }

    private SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaLoadCell(final SpreadsheetEngineEvaluation evaluation,
                                                                           final SpreadsheetEngine engine,
                                                                           final SpreadsheetEngineContext context) {
