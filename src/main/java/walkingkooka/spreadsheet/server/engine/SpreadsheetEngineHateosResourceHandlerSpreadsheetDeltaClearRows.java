 ...
 */
final class SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearRows extends SpreadsheetEngineHateosResourceHandlerSpreadsheetDelta2<SpreadsheetRowReference> {

    static SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearRows with(final SpreadsheetEngine engine,
                                                                                final SpreadsheetEngineContext context) {
        check(engine, context);
        return new SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearRows(engine, context);
    }

    private SpreadsheetEngineHateosResourceHandlerSpreadsheetDeltaClearRows(final SpreadsheetEngine engine,
                                                                            final SpreadsheetEngineContext context) {
